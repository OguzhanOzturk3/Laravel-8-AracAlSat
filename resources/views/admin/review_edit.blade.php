                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Review Detail</strong>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                            ...
                                            <div class="card-body card-block">
                                                <form role="form" action="{{route('admin_review_update',['id'=>$data->id])}}" method="post"  class="form-horizontal" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="table-responsive table--no-card m-b-30">
                                                        <table class="table table-borderless table-striped ">
                                                            ...
                                                            <tr>
                                                                <th>Vehicle</th><td>{{$data->car->title}}</td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <td >
                                                                ...
                                                                <button type="submit" class="btn btn-primary  col-6">
                                                                    <a class="fa fa-dot-circle-o" ></a> Update Review
                                                                </button>
